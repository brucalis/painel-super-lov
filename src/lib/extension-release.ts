...
export const ADMIN_EXTENSION_RELEASE = {
  version: "32.0.46 Teste",
  updatedAt: "23/09/2026 (horário de Brasília)",
  downloadPath: "https://painel-super-lov.lovable.app/super-lovable-admin-v32.0.46-teste.zip?v=32.0.46",
  downloadName: "superlovable-v32.0.46-teste-admin.zip",
} as const;
