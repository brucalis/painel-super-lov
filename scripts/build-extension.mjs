...
const customerZip = path.join(publicDir, "super-lovable-09.09.S8.zip");
...
customerManifest.version = "33.0.20";
customerManifest.version_name = "09.09.S8";
customerManifest.description = "Superlovable — Cloudflare principal, histórico GitHub sincronizado e execução interrompível.";
