...
const customerZip = path.join(publicDir, "super-lovable-09.09.S9.zip");
...
customerManifest.version = "33.0.21";
customerManifest.version_name = "09.09.S9";
customerManifest.description = "Superlovable — execução interrompível, histórico GitHub sincronizado e rollback direto.";
