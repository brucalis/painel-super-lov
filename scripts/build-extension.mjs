...
const customerZip = path.join(publicDir, "super-lovable-09.09.S7.zip");
...
customerManifest.version = "33.0.19";
customerManifest.version_name = "09.09.S7";
customerManifest.description = "Superlovable — Cloudflare principal, histórico GitHub e execução interrompível.";
