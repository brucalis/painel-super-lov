...
const customerZip = path.join(publicDir, "super-lovable-09.09.S10.zip");
...
customerManifest.version = "33.0.22";
customerManifest.version_name = "09.09.S10";
customerManifest.description = "Superlovable — histórico GitHub, rollback direto e execução interrompível com carregamento leve.";
